...
public class ThreadPoolConstants {
    ...
    /** status machine pool */
    public final static String MACHINE_THREAD_POOL_NAME    = "status-machine-execute-pool";
    public final static int    MACHINE_THREAD_POOL_NUM     = 50;

    /** pipeline pool */
    public final static String PIPELINE_THREAD_POOL_NAME   = "pipeline-execute-pool";
    public final static int    PIPELINE_THREAD_POOL_NUM    = 50;
