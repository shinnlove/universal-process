...
/**
 * @author Tony Zhao
 * @version $Id: AbstractStatusMachineUtilService.java, v 0.1 2022-02-22 2:19 PM Tony Zhao Exp $$
 */
public abstract class AbstractStatusMachineUtilService implements StatusMachine2ndService {
